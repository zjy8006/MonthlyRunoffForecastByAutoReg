...
def one_step_esvr_multi_seed(root_path,station,decomposer,predict_pattern,optimizer='gp',wavelet_level='db10-2',n_calls=100,cv=10,iterations=10,framework='WDDFF'):
    ...
    if decomposer=='modwt':
        data_path = root_path + '/'+signals+'/data-'+framework.lower()+'/'+wavelet_level+'/'+predict_pattern+'/'
        model_path = root_path+'/'+signals+'/projects/'+predictor+'-'+framework.lower()+'/'+wavelet_level+'/'+predict_pattern+'/history/'
    elif decomposer == 'dwt' or decomposer=='modwt':
        data_path = root_path + '/'+signals+'/data/'+wavelet_level+'/'+predict_pattern+'/'
        model_path = root_path+'/'+signals+'/projects/'+predictor+'/'+wavelet_level+'/'+predict_pattern+'/history/'
    else:
        data_path = root_path + '/'+signals+'/data/'+predict_pattern+'/'
