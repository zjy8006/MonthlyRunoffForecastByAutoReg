...
save_path = '../boundary_effect/vmd-decompositions-sunspot/';
...
label0=strcat('IMF1 of x0(',num2str(year(2)),'-',num2str(year(385)),')');
x1_imf1_1_384=plot(x1_imf(1:384,1),'r');
label1=strcat('IMF1 of x1(',num2str(year(2)),'-',num2str(year(385)),')');
...
x_1_385_dec = array2table(x_1_385_imf, 'VariableNames', columns);
writetable(x_1_385_dec, [save_path,'x_1_385_imf.csv']);

[x_1_386_imf, u_hat, omega] = VMD(x_1_386', alpha, tau, K, DC, init, tol);
x_1_386_imf = x_1_386_imf';
x_1_386_dec = array2table(x_1_386_imf, 'VariableNames', columns);
writetable(x_1_386_dec, [save_path,'x_1_386_imf.csv']);


figure('Name','Test sensitivity of adding additional data point');
hold on
x_1_386_imf1=plot(x_1_386_imf(1:386,1),'b');
label00=strcat('IMF1 of x\_1\_386(',num2str(year(1)),'-',num2str(year(386)),')');
x_1_385_imf1=plot(x_1_385_imf(1:385,1),'r');
label11=strcat('IMF1 of x\_1\_385(',num2str(year(1)),'-',num2str(year(385)),')');
...
x_1_300_dec = array2table(x_1_300_imf, 'VariableNames', columns);
writetable(x_1_300_dec, [save_path,'x_1_300_imf.csv']);
...
label11=strcat('IMF1 of x\_1\_300(',num2str(year(1)),'-',num2str(year(300)),')');
