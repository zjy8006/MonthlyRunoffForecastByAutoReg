...
def plot_objective(result, levels=10, n_points=40, n_samples=250, size=2,
                   ...
                   minimum='result', n_minimum_search=None,figsize=None):
    ...
    if figsize==None:
        ...
        fig, ax = plt.subplots(space.n_dims, space.n_dims,figsize=figsize)
...
def plot_evaluations(result, bins=20, dimensions=None,figsize=None):
