...
for i =1:length(stations)
    ...
    for j =1:length(decomposers)
        ...
        if decomposer=="modwt"
            decomposition_file=strcat("../",station,"_",decomposer,"/data-tsdp/",wavelet_level,"/",upper(decomposer),"_TRAIN.csv");
        elseif decomposer== "dwt"
            decomposition_file=strcat("../",station,"_",decomposer,"/data/",wavelet_level,"/",upper(decomposer),"_TRAIN.csv");
        else
        ...
        if decomposer=="modwt"
            save_path = strcat("../",station,"_",decomposer,"/data-tsdp/",wavelet_level,"/")
        elseif decomposer=="dwt"
            save_path = strcat("../",station,"_",decomposer,"/data/",wavelet_level,"/")             
        else
