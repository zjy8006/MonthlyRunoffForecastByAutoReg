...
from Xianyang_eemd.projects.variables import variables
...
orig_series = pd.read_excel(root_path+'/time_series/XianyangRunoff1951-2018(1953-2018).xlsx')['MonthlyRunoff']
...
ensemble(
        ...
        variables = variables,
        predictor=PREDICTOR,
        predict_pattern='one_step_1_ahead_forecast_pacf_pca23',
    )
