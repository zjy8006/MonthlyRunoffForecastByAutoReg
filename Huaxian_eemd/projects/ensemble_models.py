...
from Huaxian_eemd.projects.variables import variables
...
orig_series = pd.read_excel(root_path+'/time_series/HuaxianRunoff1951-2018(1953-2018).xlsx')['MonthlyRunoff']
