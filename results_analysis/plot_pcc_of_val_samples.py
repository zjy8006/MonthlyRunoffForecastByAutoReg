...
plt.savefig(graphs_path+'Absolute PCC of appended samples and validation samples.eps',format='EPS', dpi=2000)
plt.savefig(graphs_path+'Absolute PCC of appended samples and validation samples.tif',format='TIFF', dpi=500)
plt.savefig(graphs_path+'Absolute PCC of appended samples and validation samples.pdf',format='PDF', dpi=1200)
plt.show()