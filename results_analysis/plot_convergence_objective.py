...
# plt.tight_layout()
plt.savefig(graphs_path+'BOGP Objective of VMD-SVR at Huaxian.eps',format="EPS",dpi=2000)
plt.savefig(graphs_path+'BOGP Objective of VMD-SVR at Huaxian.tif',format="TIFF",dpi=1200)
plt.savefig(graphs_path+'BOGP Objective of VMD-SVR at Huaxian.pdf',format="PDF",dpi=1200)
plt.show()