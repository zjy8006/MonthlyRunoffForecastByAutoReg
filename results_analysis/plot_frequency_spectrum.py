...
plt.savefig(graphs_path+"Frequency spectrum of Huaxian.eps",format="EPS",dpi=2000)
plt.savefig(graphs_path+"Frequency spectrum of Huaxian.tif",format="TIFF",dpi=500)
plt.savefig(graphs_path+"Frequency spectrum of Huaxian.pdf",format="PDF",dpi=1200)
plt.show()
