...
plt.savefig(graphs_path+"Fig.13.Two stage pca nse.eps",format="EPS",dpi=2000)
plt.savefig(graphs_path+"Fig.13.Two stage pca nse.tif",format="TIFF",dpi=500)
plt.savefig(graphs_path+"Fig.13.Two stage pca nse.pdf",format="PDF",dpi=1200)
plt.show()
