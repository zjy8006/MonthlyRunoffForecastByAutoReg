...
records={
    ...
    'h_svr' : h_svr['test_y'][0:120].values,
    ...
    'x_svr' : x_svr['test_y'][0:120].values,
    ...
    'z_svr' : z_svr['test_y'][0:120].values,
...
preds={
    ...
    'h_svr' : h_svr['test_pred'][0:120].values,
    ...
    'x_svr' : x_svr['test_pred'][0:120].values,
    ...
    'z_svr' : z_svr['test_pred'][0:120].values,
...
h_labels=[
    ['h_arma','h_svr','h_m_1','h_e_1','h_s_1','h_d_1','h_v_1',],
    ['h_m_3','h_e_3','h_s_3','h_d_3','h_v_3',],
    ['h_m_5','h_e_5','h_s_5','h_d_5','h_v_5',],
    ['h_m_7','h_e_7','h_s_7','h_d_7','h_v_7',],
]
h_xx,h_linear_list,h_xymin,h_xymax = compute_multi_linear_fit(h_records,h_preds)
markers0=['<','v','s','*','+','^','o']
markers=['s','*','+','^','o']
colors0=['tab:red','tab:green','tab:orange','tab:cyan','tab:purple','tab:gray','tab:blue']
...
data=[
    [h_arma,h_svr,h_m_1,h_e_1,h_s_1,h_d_1,h_v_1],
    [x_arma,x_svr,x_m_1,x_e_1,x_s_1,x_d_1,x_v_1],
    [z_arma,z_svr,z_m_1,z_e_1,z_s_1,z_d_1,z_v_1],
    [h_m_3,h_e_3,h_s_3,h_d_3,h_v_3],
    [x_m_3,x_e_3,x_s_3,x_d_3,x_v_3],
    [z_m_3,z_e_3,z_s_3,z_d_3,z_v_3],
    [h_m_5,h_e_5,h_s_5,h_d_5,h_v_5],
    [x_m_5,x_e_5,x_s_5,x_d_5,x_v_5],
    [z_m_5,z_e_5,z_s_5,z_d_5,z_v_5],
    [h_m_7,h_e_7,h_s_7,h_d_7,h_v_7],
    [x_m_7,x_e_7,x_s_7,x_d_7,x_v_7],
    [z_m_7,z_e_7,z_s_7,z_d_7,z_v_7],
]

h_data_rds=[
    [h_arma['test_y'],h_svr['test_y'][0:120].values,h_m_1['test_y'][0:120].values,h_e_1['test_y'][0:120].values,h_s_1['test_y'][0:120].values,h_d_1['test_y'][0:120].values,h_v_1['test_y'][0:120].values],
...
h_data_pds=[
    [h_arma['test_pred'],h_svr['test_pred'][0:120].values,h_m_1['test_pred'][0:120].values,h_e_1['test_pred'][0:120].values,h_s_1['test_pred'][0:120].values,h_d_1['test_pred'][0:120].values,h_v_1['test_pred'][0:120].values],
