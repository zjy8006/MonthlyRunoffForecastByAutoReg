...
plt.tight_layout()
plt.savefig(graphs_path+'PACF of VMD IMF1 at Huaxian.tif',  format='TIFF', dpi=500)
plt.savefig(graphs_path+'PACF of VMD IMF1 at Huaxian.PDF',  format='PDF', dpi=1200)
plt.savefig(graphs_path+'PACF of VMD IMF1 at Huaxian.eps',  format='EPS', dpi=2000)
plt.show()